...
urlpatterns = patterns('',
    ...
    lr_url(r'^orders/$', OrderList.as_view(), name='order_all'),
    lr_url(r'^orders/$', OrderOutstanding.as_view(), name='order_outstanding'),
    lr_url(r'^orders/outstanding/$', OrderList.as_view(), name='order_all'),
